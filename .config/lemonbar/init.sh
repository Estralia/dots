...
("$HOME"/.config/lemonbar/blank.sh | env lemonbar -g 3840x4+3840+0 -d -B "#CF000000") &
("$HOME"/.config/lemonbar/bar.sh | env lemonbar -g 3840x30+3840+4 -d -B "#CF000000" -o 1 -f "DejaVu Sans Mono:style=Book:pixelsize=14" -o 0 -f "Font Awesome 7 Free:style=Solid:pixelsize=15.5") &
("$HOME"/.config/lemonbar/blank.sh | env lemonbar -g 3840x4+3840+34 -d -B "#CF000000") &
